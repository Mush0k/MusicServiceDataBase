CREATE DATABASE  IF NOT EXISTS `kibby` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_bin */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `kibby`;
-- MySQL dump 10.13  Distrib 8.0.43, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: kibby
-- ------------------------------------------------------
...
CREATE TABLE `album` (
  ...
  `album_title` varchar(45) COLLATE utf8_bin NOT NULL COMMENT 'название альбома',
  `artist_id` int NOT NULL COMMENT 'внешний ключ  исполнителя',
  `release_date` date DEFAULT NULL COMMENT 'дата релиза',
  `cover_url` varchar(255) COLLATE utf8_bin DEFAULT NULL COMMENT 'обложка альбома',
...
CREATE TABLE `artist` (
  ...
  `artist_name` varchar(255) COLLATE utf8_bin NOT NULL COMMENT 'название исполнителя/группы',
  `founded_year` int DEFAULT NULL COMMENT 'год основания/начала деятельности',
  `artist_bio` text COLLATE utf8_bin COMMENT 'биография',
  `artist_photo_url` varchar(255) COLLATE utf8_bin DEFAULT NULL COMMENT 'ссылка на фото исполнителя',
...
CREATE TABLE `artist_has_country` (
  ...
  `country_code` char(2) COLLATE utf8_bin NOT NULL COMMENT ' внешний ключ страны',
...
CREATE TABLE `artist_type` (
  ...
  `type_name` varchar(45) COLLATE utf8_bin NOT NULL COMMENT 'название типа исполнителя',
  PRIMARY KEY (`type_id`)
...
CREATE TABLE `country` (
  `country_code` char(2) COLLATE utf8_bin NOT NULL COMMENT 'код страны (пример - RU)',
  `country_name` varchar(255) COLLATE utf8_bin NOT NULL COMMENT 'название страны',
...
CREATE TABLE `credit_type` (
  ...
  `credit_name` varchar(45) COLLATE utf8_bin NOT NULL COMMENT 'название роли',
...
CREATE TABLE `genre` (
  ...
  `genre_name` varchar(45) COLLATE utf8_bin DEFAULT NULL COMMENT 'название жанра',
...
CREATE TABLE `member` (
  ...
  `full_name` varchar(255) COLLATE utf8_bin NOT NULL COMMENT 'настоящее имя и фамилия участника',
  `stage_name` varchar(255) COLLATE utf8_bin DEFAULT NULL COMMENT 'сценическое имя',
  `birth_date` date DEFAULT NULL COMMENT 'дата рождения',
  `member_bio` text COLLATE utf8_bin COMMENT 'биография',
  `member_photo_url` varchar(255) COLLATE utf8_bin DEFAULT NULL COMMENT 'ссылка на фото участника',
...
CREATE TABLE `playlist` (
  ...
  `playlist_title` varchar(255) COLLATE utf8_bin DEFAULT NULL COMMENT 'название плейлиста',
  `description` text COLLATE utf8_bin COMMENT 'описание',
  `creation_date` datetime DEFAULT NULL COMMENT 'дата создания',
  `cover_url` varchar(255) COLLATE utf8_bin DEFAULT NULL COMMENT 'обложка плейлиста',
...
CREATE TABLE `subscription_type` (
  ...
  `sub_name` varchar(45) COLLATE utf8_bin NOT NULL COMMENT 'название подписки',
  ...
  `features` text COLLATE utf8_bin COMMENT 'особенности подписки',
  PRIMARY KEY (`type_id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `track` (
  ...
  `track_title` varchar(255) COLLATE utf8_bin NOT NULL COMMENT 'название трека',
  ...
  `audio_url` varchar(255) COLLATE utf8_bin NOT NULL COMMENT 'ссылка на аудиодорожку',
...
CREATE TABLE `user` (
  ...
  `user_name` varchar(45) COLLATE utf8_bin NOT NULL COMMENT 'имя пользователя',
  `email` varchar(255) COLLATE utf8_bin NOT NULL COMMENT 'почта аккаунта пользователя',
  `password_hash` varchar(255) COLLATE utf8_bin NOT NULL COMMENT 'хэш пароля пользователя',
  ...
  `avatar_url` varchar(255) COLLATE utf8_bin DEFAULT NULL COMMENT 'ссылка на аватар пользователя',
...
-- Dump completed on 2025-12-25 13:34:02
